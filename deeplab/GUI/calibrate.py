"""
Source: https://github.com/jagracar/OpenCV-python-tests/blob/master/OpenCV-tutorials/cameraCalibration/cameraCalibration.py
"""
...
img = cv2.imread('./data/2018-11-17-162522_1.jpg')
h, w = img.shape[:2]
